...
expected=(
  ...
  packaging/systemd/ppflight-agent.service packaging/systemd/ppflight-agent-upgrade.path packaging/systemd/ppflight-agent-upgrade.service packaging/systemd/ppflight-host-firewall.service packaging/systemd/ppflight-node-exporter.service packaging/systemd/ppflight-smartctl-exporter.service
  packaging/tmpfiles.d/ppflight-agent.conf
  scripts/install.sh scripts/quick-install.sh scripts/uninstall.sh scripts/create-pve-tokens.sh scripts/remove-pve-credentials.sh scripts/migrate-legacy-template-timezone.py scripts/verify-template-bundle.py
