...
func validActionParameterFixtures() map[string]string {
	return map[string]string{
		...
		"vm.set-disk-limits":           `{"disk":"scsi0","iopsRead":1000,"iopsWrite":1000}`,
		"vm.set-network":               `{"interface":"net0","bridge":"vmbr1"}`,
		"vm.set-rate":                  `{"interface":"net0","rateMbps":"10"}`,
		"vm.set-cloud-init":            `{"username":"root","password":"secret-value","sshKeys":["ssh-ed25519 QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUE="],"hostname":"vm101","enableQGA":true}`,
		"vm.set-timezone":              `{"timezone":"UTC"}`,
		"vm.verify-delivery":           `{"interface":"net0","expectedMac":"AA:BB:CC:DD:EE:FF","expectedAddresses":["192.0.2.10"],"requireQGA":true}`,
